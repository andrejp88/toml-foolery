module toml_foolery.decode.types.datetime;
...
package(toml_foolery.decode) DateAndOrTime parseTomlGenericDateTime(string value)
{
...
package(toml_foolery.decode) SysTime parseTomlOffsetDateTime(string value)
{
...
package(toml_foolery.decode) SysTime parseTomlLocalDateTime(string value)
{
    DateAndOrTime dt = parseTomlGenericDateTime(value);
...
package(toml_foolery.decode) Date parseTomlLocalDate(string value)
{
    DateAndOrTime dt = parseTomlGenericDateTime(value);
...
package(toml_foolery.decode) TimeOfDay parseTomlLocalTime(string value)
{
    DateAndOrTime dt = parseTomlGenericDateTime(value);
